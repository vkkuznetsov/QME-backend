...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['from_elective_id'], ['elective.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.ForeignKeyConstraint(['to_consultation_group_id'], ['group.id'], ),
    sa.ForeignKeyConstraint(['to_elective_id'], ['elective.id'], ),
    sa.ForeignKeyConstraint(['to_lab_group_id'], ['group.id'], ),
    sa.ForeignKeyConstraint(['to_lecture_group_id'], ['group.id'], ),
    sa.ForeignKeyConstraint(['to_practice_group_id'], ['group.id'], ),
    sa.PrimaryKeyConstraint('id')
    )

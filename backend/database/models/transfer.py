...
class Transfer(Base):
    ...
    manager_id: Mapped[int | None] = mapped_column(
        ForeignKey("manager.id"), nullable=True
    )

    from_elective_id: Mapped[int] = mapped_column(
        ForeignKey("elective.id"), nullable=False
    )
    to_elective_id: Mapped[int] = mapped_column(
        ForeignKey("elective.id"), nullable=False
    )
    ...
    from_elective: Mapped["Elective"] = relationship(
        "Elective", foreign_keys=[from_elective_id]
    )
    to_elective: Mapped["Elective"] = relationship(
        "Elective", foreign_keys=[to_elective_id]
    )
    ...
    groups_to: Mapped[List["Group"]] = relationship(
        ...
        primaryjoin=and_(
            transfer_group.c.transfer_id == id,
